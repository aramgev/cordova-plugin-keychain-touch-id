        ...
        try {
            ...
            if (withFingerprint) {
                ...
                if(mCurrentMode == Cipher.DECRYPT_MODE){
                    byte[] enc = Base64.decode(sharedPref.getString("fing" + mKeyID, ""),Base64.NO_WRAP);
                    ...
                    editor.putString("fing"+ mKeyID,Base64.encodeToString(enc, Base64.NO_WRAP));
                    editor.putString("fing_iv"+ mKeyID,Base64.encodeToString(mCipher.getIV(), Base64.NO_WRAP));
